...
$query = "SELECT * FROM course WHERE crs_id='IM2015'"; 
...
<?php
	...
	<input type='hidden' name='f_name' id='f_name' value='107_Fall_IM2015'/><br/>
...
insert_content('107_Fall_IM2015.php', $user_input);
?>
