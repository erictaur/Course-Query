...
$query = "SELECT * FROM course WHERE crs_id='IM4021'"; 
...
<?php
	...
	<input type='hidden' name='f_name' id='f_name' value='107_Fall_IM4021'/><br/>
...
insert_content('107_Fall_IM4021.php', $user_input);
?>
