...
$query = "SELECT * FROM course WHERE crs_id='MA1001-C'"; 
...
<?php
	...
	<input type='hidden' name='f_name' id='f_name' value='107_Fall_MA1001-C'/><br/>
...
insert_content('107_Fall_MA1001-C.php', $user_input);
?>
