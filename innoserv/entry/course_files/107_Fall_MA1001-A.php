...
$query = "SELECT * FROM course WHERE crs_id='MA1001-A'"; 
...
<?php
	...
	<input type='hidden' name='f_name' id='f_name' value='107_Fall_MA1001-A'/><br/>
...
insert_content('107_Fall_MA1001-A.php', $user_input);
?>
